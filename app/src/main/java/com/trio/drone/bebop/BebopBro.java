...
public class BebopBro implements BebopMediator, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    @Override
    public void register(BebopEventListener listener) {
        listeners.add(listener);
    }

    @Override
    public void unregister(BebopEventListener listener) {
    ...
    public void doEmergencyLanding() {
        controlStrategy.doEmergencyLanding(controller);
    }

    @Override
    public void takeOff() {
        controlStrategy.takeOff(controller);
    }
    ...
    @Override
    public void land() {
        controlStrategy.land(controller);
    }

    public void setVideoSurface(Surface surface) {
        controller.startVideo(surface);
    }
    ...
    public FlyingState getFlyingState() {
        return controller.GetFlyingState();
    }
