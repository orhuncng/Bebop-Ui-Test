...
public class CanvasQuad
{
    ...
    private static final String[] fragmentShaderCode = {
            ...
            "uniform samplerExternalOES uTexture;", "uniform float uAlpha;",
    ...
    private static final float[] vertexData =
            {-WIDTH / 2, -HEIGHT / 2, -DISTANCE, 0, 1, WIDTH / 2, -HEIGHT / 2, -DISTANCE, 1, 1,
                    -WIDTH / 2, HEIGHT / 2, -DISTANCE, 0, 0, WIDTH / 2, HEIGHT / 2, -DISTANCE, 1,
                    0};
    ...
    public Canvas lockCanvas()
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
            return displaySurface.lockHardwareCanvas();
        else return displaySurface.lockCanvas(null);
    }
    ...
    void glInit()
    {
        ...
        displaySurfaceTexture.setDefaultBufferSize((int) (WIDTH * PX_PER_UNIT),
                (int) (HEIGHT * PX_PER_UNIT));
        displaySurface = new Surface(displaySurfaceTexture);
    }

    void glInit(SurfaceTexture.OnFrameAvailableListener listener)
    {
        glInit();
        displaySurfaceTexture.setOnFrameAvailableListener(listener);
    }
